...
if args.crepe:
   commands = [
      ...
      "python prepare/preprocess_speaker.py data_svc/waves-16k/ data_svc/speaker -t "+str(args.t),
      "python prepare/preprocess_speaker_ave.py data_svc/speaker/ data_svc/singer -t "+str(args.t),
      "python prepare/preprocess_spec.py -w data_svc/waves-32k/ -s data_svc/specs -t "+str(args.t),
      "python prepare/preprocess_train.py -t "+str(args.t),
